...
def sniff_baslat():
    ...
    sniff(
        prn=paket_yakala,
        store=False,
        stop_filter=lambda x: not calisiyor
    )
...
app.title("Final Boss - Network Monitor")
...
tree.heading(
    "src",
    text="Source",
    command=lambda: kolon_filtrele("src")
)

tree.heading(
    "dst",
    text="Destination",
    command=lambda: kolon_filtrele("dst")
)

tree.heading(
    "proto",
    text="Protocol",
    command=lambda: kolon_filtrele("proto")
)

tree.heading(
    "port",
    text="Port",
    command=lambda: kolon_filtrele("port")
)
